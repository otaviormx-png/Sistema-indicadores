...
CODE = 'C5'
TITULO = 'PLANILHA DE CUIDADO DA PESSOA COM HIPERTENSÃO  |  Indicador C5 – Atenção Primária à Saúde'
CRITERIO_BLOCO = '◀ CRITÉRIOS C5 – NOTA METODOLÓGICA ▶'
SUBTITULO = 'Cada critério vale 25 pts  |  A=Consulta médico/enf (6m)  |  B=PA aferida (6m)  |  C=Peso+altura (12m)  |  D=≥2 visitas ACS (12m)'
THEME_KEYWORDS = ['Hipertensão', 'hipertensao']
OFFICIAL_LIKE = True
